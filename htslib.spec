...
Source0  : https://github.com/samtools/htslib/releases/download/1.21/htslib-1.21.tar.bz2
...
%prep
%setup -q -n htslib-1.21
cd %{_builddir}/htslib-1.21
pushd ..
cp -a htslib-1.21 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727476652
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libhts.so.1.21
/usr/lib64/libhts.so.1.21
