...
Source0  : https://github.com/samtools/htslib/releases/download/1.16/htslib-1.16.tar.bz2
...
%prep
%setup -q -n htslib-1.16
cd %{_builddir}/htslib-1.16
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672177108
...
cp %{_builddir}/htslib-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/htslib/2ec75da78dd85b1626da361c5603db273dac4cd2
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libhts.so.1.16
/usr/lib64/libhts.so.3

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/htslib/2ec75da78dd85b1626da361c5603db273dac4cd2
