...
Source0  : https://github.com/samtools/htslib/releases/download/1.20/htslib-1.20.tar.bz2
...
%prep
%setup -q -n htslib-1.20
cd %{_builddir}/htslib-1.20
pushd ..
cp -a htslib-1.20 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713206349
...
cp %{_builddir}/htslib-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/htslib/541760bf26f52ef94859789c9e91c4b2b0218baa || :
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libhts.so.1.20
/usr/lib64/libhts.so.1.20
/usr/lib64/libhts.so.3

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/htslib/541760bf26f52ef94859789c9e91c4b2b0218baa
