...
Source0  : https://github.com/samtools/htslib/releases/download/1.12/htslib-1.12.tar.bz2
...
%prep
%setup -q -n htslib-1.12
cd %{_builddir}/htslib-1.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625201890
...
cp %{_builddir}/htslib-1.12/LICENSE %{buildroot}/usr/share/package-licenses/htslib/a00a4c74a82119045d0edfe1743ee781752b07e2
cp %{_builddir}/htslib-1.12/htscodecs/LICENSE.md %{buildroot}/usr/share/package-licenses/htslib/6c4957c5b4497597ff61a6a6cef7b08eacbc7731
%make_install
